...
- Otherwise use `ak:repomix` to generate fresh codebase summary
- Use `/ak:scout` or `/ak:scout ext` to find relevant files
- Use `ak:docs-seeker` skill for package/plugin documentation
