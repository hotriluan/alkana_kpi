...
- For ambiguous workflow sequence, load `.claude/skills/ak-cook/references/workflow-routing.md`.
...
- Explain the result plainly; use `/ak:preview` only for complex workflows or architecture. For mode selection, load `.claude/skills/ak-preview/references/visual-explanation-routing.md`.
