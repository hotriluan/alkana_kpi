...
## Your mission
Propose a plan to create a new skill in the project skill directory.
...
- Analyze the given task and use `ask_user capability` tool to ask for more details if needed.
