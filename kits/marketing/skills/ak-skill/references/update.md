...
## Your mission
Update an existing skill or its reference files in the project skill directory based on the user's prompt.
...
## IMPORTANT NOTES:
- ALWAYS make changes to skills in the project-scope skill directory (UNLESS you're allowed to).
- DO NOT make any changes to skills in the home/user-scope skill directory (UNLESS you're allowed to).
- If you're given nothing, use `ask_user capability` tool for clarifications and `researcher` subagent to research about the topic.
