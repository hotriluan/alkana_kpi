...
After logo generation completes, **ALWAYS** use the the `ask_user` capability to ask if the user wants to preview all generated logos in a single eye-catching HTML file.

**ask_user capability parameters:**
```json
{
  "questions": [{
