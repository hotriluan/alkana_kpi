...
```bash
python3 scripts/search.py "<campaign_type> <audience> <industry>" --creative-brief [-c "Campaign Name"]
```
...
**Example:**
```bash
python3 scripts/search.py "SaaS product launch gen z" --creative-brief -c "App Launch Campaign"
```
...
```bash
python3 scripts/search.py "gen z saas product tiktok" --creative-brief -c "SaaS Launch"
```
...
python3 scripts/search.py "tiktok" --domain platform

# Get Gen Z style options
python3 scripts/search.py "gen z authentic raw" --domain style
```
...
python3 scripts/search.py "e-commerce launch" --creative-brief

# Markdown - best for documentation
python3 scripts/search.py "e-commerce launch" --creative-brief -f markdown
```
