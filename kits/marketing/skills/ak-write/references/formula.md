...
- `${CLAUDE_PLUGIN_ROOT}/skills/ak-copywriting/references/copy-formulas.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/ak-copywriting/references/power-words.md`
...
- `brand` - Voice, tone, prohibited words
