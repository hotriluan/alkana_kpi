---
name: ak:init
description: 💡💡💡💡 Initialize marketing project — scaffold docs/ structure, brand-guidelines.md, design-guidelines.md, and project setup. Use when starting a new marketing project or onboarding an existing one.
...
3. **Verify with user via `ask_user` capability**:
...
Use the `ask_user` capability for each section.
...
1. **Analyze Available Commands**
   - Run `python .agentkit/scripts/generate_catalogs.py --commands`
