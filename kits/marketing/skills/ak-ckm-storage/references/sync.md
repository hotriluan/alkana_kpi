...
2. Load s3-client from `${CLAUDE_PLUGIN_ROOT}/skills/ak-storage/scripts/s3-client.cjs`
...
**Script Usage:**
```javascript
const s3 = require(process.env.CLAUDE_PLUGIN_ROOT + '/skills/ak-storage/scripts/s3-client.cjs');
