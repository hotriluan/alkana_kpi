...
Activate `email` skill and read:
- `${CLAUDE_PLUGIN_ROOT}/skills/ak-email/references/automation-flows.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/ak-email/references/subject-line-formulas.md`
- `${CLAUDE_PLUGIN_ROOT}/skills/ak-email/references/email-templates.md`
...
- `email` - Sequence templates, timing, automation
- `copywriting` - Email copy formulas, subject lines
- `brand` - Voice, tone, CTA style
