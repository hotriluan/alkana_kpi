...
1. **Extract Video Highlights**
   ...
   - Run VidCap API:
     ...
     python ${CLAUDE_PLUGIN_ROOT}/skills/ak-youtube/scripts/vidcap.py comments "<url>" --order relevance
...
3. **Hook Writing Rules**
   - Reference `social/references/hook-writing.md`
   - AVOID:
...
- `social` - Platform specs, posting best practices
