...
1. **Extract Video Content**
   ...
   - Run VidCap API:
     ...
     python ${CLAUDE_PLUGIN_ROOT}/skills/ak-youtube/scripts/vidcap.py article "<url>"

     # Or custom extraction for more control
     python ${CLAUDE_PLUGIN_ROOT}/skills/ak-youtube/scripts/vidcap.py summary-custom "<url>" \
...
- `seo` - Keyword research, meta optimization
