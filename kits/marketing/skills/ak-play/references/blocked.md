...
4. **Analyze Gate-Pending Steps**
   ...
   - Suggest: `/ak:play gate {slug} {step} approve` or `reject`.
...
5. **Display Blocker Report**
   ...
   3. "Content quality review" — gate-pending
      ...
      Action: /ak:play gate launch content-quality-review approve
   ```
...
- No blocked steps → report "All clear" and suggest `/ak:play next`.
