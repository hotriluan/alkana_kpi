...
6. **Suggest Action** — output: `Run /ak:play next {slug} to execute the next step.`

## Error Handling

- No playbooks found → suggest `/ak:play create`.
- Manifest corrupted → report error, suggest `/ak:play reset`.
