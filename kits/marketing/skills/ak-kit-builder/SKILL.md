...
Build skills, agents, commands, and workflows for AgentKit Marketing.
...
|------|----------|---------|
| Skill | `skills/{name}/SKILL.md` | Domain knowledge + tools |
| Agent | `agents/{name}.md` | Specialized subagent |
| Command | `commands/{path}.md` | User-invocable action |
| Workflow | `workflows/{name}.md` | Process orchestration |
...
```bash
python scripts/init_component.py <type> <name>
```
