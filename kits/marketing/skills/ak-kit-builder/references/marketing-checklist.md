...
Status map for AgentKit Marketing capabilities.
...
1. **New Skill**
   ```bash
   python ${CLAUDE_PLUGIN_ROOT}/skills/ak-kit-builder/scripts/init_component.py skill {name}
   ```

2. **New Command**
   ```bash
   python ${CLAUDE_PLUGIN_ROOT}/skills/ak-kit-builder/scripts/init_component.py command {name}
   ```
