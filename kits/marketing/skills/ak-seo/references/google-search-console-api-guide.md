...
## Quick Start (AgentKit Scripts)

AgentKit provides cross-platform scripts for GSC integration. Use these for most tasks:
...
**Step 3: Authenticate with AgentKit Script**
```bash
