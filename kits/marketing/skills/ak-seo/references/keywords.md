...
2. **Research Keywords via ReviewWeb API**
   ...
   - Use `web_search capability` for competitive analysis
   - Activate `seo` skill for keyword clustering
...
- Skill: `seo/references/reviewweb-api.md`
...
## Skills Used
- `seo` - Keyword research frameworks, ReviewWeb API
