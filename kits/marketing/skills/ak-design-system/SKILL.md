...
| generated design token JSON | Token definitions (primitive→semantic→component) |
| generated design token CSS | CSS variables (import in slides) |
| generated slide animation CSS | CSS animation library |
...
**ALL slides MUST:**
1. Import the generated design-token CSS - single source of truth
