...
Commands were migrated to skills. This script now writes an empty commands
dataset for backward compatibility with older tooling.
"""

from pathlib import Path

def main() -> None:
    """Write an empty compatibility catalog."""
