...
model: sonnet
---
<!-- kit-specific: code review domain — marketing reviews copy/content/campaigns (senior software generalist + brand alignment focus); engineer reviews code with Staff Engineer + security/perf checklist; see epic #7 -->
