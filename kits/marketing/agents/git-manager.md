...
---
<!-- kit-specific: git-manager intent diverges — marketing is a full workflow agent with split-commit analysis, PR creation, Gemini delegation, and token optimization; engineer is a lean executor (EXACTLY 2-4 tool calls) for subagent team mode; see epic #7 -->
